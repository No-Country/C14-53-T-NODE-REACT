  ...
  return (
    <>
      <main className='container relative z-20 mx-auto pt-[86px] md:pt-[150px]'>
              ...
              <div className='flex flex-col'>
                <Link to='/calendar' className='text-center group'>
                  <div className='overflow-hidden rounded-[20px] mb-4 shadow-3xl'>
                    <img className='transition-transform group-hover:scale-125' src='./img/dashboard-img-01.jpg' alt='Icono Calendario' />
                  </div>
        ...
        <Misc isVisible={showMiscModal} onClose={() => setShowMiscModal(false)}></Misc>
      </main>
    </>
  )
}
