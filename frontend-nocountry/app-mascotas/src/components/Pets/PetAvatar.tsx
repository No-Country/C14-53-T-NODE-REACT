export const PetAvatar = ({ img, name }: { img: string; name: string }) => {
  return (
    <div className="xl:px-4 flex-shrink-0 flex flex-col items-center ">
      <img className='mb-2 w-[66px] h-[66px] md:w-[120px] md:h-[120px]  xl:w-[150px] xl:h-[150px] hover:border-4 hover:border-solid border-black rounded-full' src={img} alt='{name}' />
