...
export const MyPets = () => {
  ...
  const [showAddHistoryModal, setShowAddHistoryModal] =
  ...
  return (
    <>
      <main className="container mx-auto relative z-20 flex pt-[86px] md:pt-[80px] 2xl:pt-[150px]  ">
        <div className="flex flex-col items-center gap-8 lg:gap-0 z-90 lg:items-stretch">
          <div className=" text-montserrat relative  h-[160px] md:h-[220px] xl:h-[260px]   w-[85%] lg:w-[90%] xl:w-[95%] md:mx-8 md:mb-8 md:px-12    rounded-xl lg:rounded-2xl shadow-[0_0_38px_0_rgba(0,0,0,0.25)] bg-[#F6F3E9]">
            <h2 className="text-center py-2 font-black text-[1rem] xl:text-2xl">
              Tus mascotas
            </h2>
            {MyPets.length ? (
              <>
                <div className="flex items-center justify-between">
                  <a className="absolute left-2 top-[38%]" href="#firstslide">
                    <img
                      className="hidden mb-12 rotate-180 lg:flex"
                  ...
                  <a className="absolute right-2 top-[38%]" href="#anchor">
                    <img
                      className="hidden mb-12 lg:flex"
                      src="./img/arrow-right.svg"
                      alt="carrousel-arrow-right"
                    />
                  </a>
          ...
          <div className="h-[47vh] overflow-y-hidden flex flex-col  lg:flex-row  lg:gap-4 items-center py-6 lg:mt-0 text-montserrat relative w-[85%] lg:w-[90%] xl:w-[95%]  md:mx-8 rounded-xl lg:rounded-2xl shadow-[0_0_38px_0_rgba(0,0,0,0.25)] bg-[#F6F3E9]">
            <button className="absolute lg:hidden right-8 ">
              <img
                className="md:scale-150"
                src="./img/addtasks.svg"
                alt="add-task-button"
              />
            </button>

            <img
              className="w-[100px] h-[100px] lg:w-[180px] lg:h-[180px] xl:h-[200px] xl:w-[330px] lg:ml-5 rounded-full xl:rounded-full   "
              src={selectedPet?.image || "./img/anonym-pet.jpeg"}
            ...
            <div className="flex flex-col lg:gap-3">
              <div className="grid grid-cols-3 place-items-center m-4 gap-3  text-[10px] md:text-sm xl:text-xl">
                ...
                <div className="flex gap-1 ml-20">
                  <h2 className="font-black whitespace-nowrap">
                    Fecha de nacimiento:
                  </h2>
              ...
              <div className="flex flex-col items-center gap-2">
                <h2 className="text-[12px] font-black md:text-sm xl:text-xl">
                  Descripcion Adicional
                </h2>
                <p className="text-[10px] md:text-sm px-4 font-[700] mt-2  xl:text-lg">
        ...
        <div className="hidden lg:flex flex-col text-montserrat py-6 2xl:py-6 h-[85vh] 2xl:h-[79vh] items-center gap-12    mb-8 mx-8  relative  lg:w-[90%] xl:w-[50%] 2xl:w-[40%]  rounded-xl lg:rounded-2xl shadow-[0_0_38px_0_rgba(0,0,0,0.25)] bg-[#F6F3E9]">
          ...
          <ul className="font-bold text-center lg:text-lg xl:text-2xl">
            ...
            <li className="py-4 xl:py-7">
              {selectedPet ? (
                <button onClick={() => deletePet(selectedPet.id!)}>
                  Eliminar
                </button>
              ) : (
                ""
