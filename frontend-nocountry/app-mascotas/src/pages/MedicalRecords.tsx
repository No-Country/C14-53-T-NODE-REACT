  ...
  return (
    <section className="flex h-screen w-screen relative z-30 jusfify-center items-center gap-12">
      ...
      <div className="containerbox w-[120vh] h-[800px] relative text-montserrat">
        ...
        <div className="pt-8 overflow-x-hidden overflow-y-auto mt-[-x] md:mt-0    xl:w-[95%]">


          <table className="w-full text-center text-gray-500 dark:text-gray-400">

            <thead className="text-[10px]  lg:text-lg text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 bg-[#F0F0F1] w-[99%]">
              <tr>
