  ...
  return (
    <section className="flex flex-col lg:flex-row h-[100vh] overflow-x-hidden overflow-y-hidden top-20 w-screen  relative z-30 items-center lg:items-start lg:gap-12 gap-4 ">
      ...
      <div className='containerbox w-[90%]  lg:w-auto  lg:ml-8  lg:mt-6 xl:mt-12 xl:ml-16  lg:flex  rounded-2xl  '>
        <div className='pb-3  text-center   lg:h-[600px] xl:h-[700px] overflow-auto'>
          ...
          <div className='flex justify-center gap-3 lg:gap-7 lg:grid px-6'>
            <PetAvatar name={"Pedro"} fn={null} img={null}></PetAvatar>
            <PetAvatar name={"Pedro"} fn={null} img={null}></PetAvatar>
            <PetAvatar name={"Pedro"} fn={null} img={null}></PetAvatar>
            <PetAvatar name={"Pedro"} fn={null} img={null}></PetAvatar>
      ...
      <div className="containerbox xl:mt-12 h-[380px] lg:mt-6 2xl:ml-12 md:h-[500px] w-[90%] lg:w-[75%] py-2 xl:w-[120vh] flex flex-col items-center lg:h-[600px] xl:h-[700px] relative text-montserrat">
        <h1 className=" text-lg  lg:text-3xl xl:text-[48px] font-black lg:uppercase lg:absolute lg:left-[-25px] lg:top-[-20px] xl:top-[-22px] xl:left-[-30px]">Historia medica</h1>
        <div className="relative my-2 ">
          <input type="text" placeholder="Busca una historia" className="rounded-md lg:rounded-lg border-2 h-10 w-full lg:w-[350px] py-2 px-3  focus:outline-none" />
        ...
        <div className="pt-2 overflow-x-hidden overflow-y-auto  md:mt-0    xl:w-[95%]">
          ...
          <table className="w-full text-center text-gray-500 ">
            ...
            <thead className="text-[10px]  lg:text-lg text-gray-700 uppercase bg-gray-50 bg-[#F0F0F1] w-[99%]">
              <tr>
                ...
                <th scope="col" className="hidden ">
                  ...
                  <div className="relative ">
                    <input type="text" placeholder="Busca una actividad" className="rounded-md lg:rounded-lg border-2 h-10 w-full lg:w-[350px] py-2 px-3  focus:outline-none" />
                    <img className="absolute right-3 top-3 scale-150 " src="./img/search-icon.svg" alt="search-icon" />
                  </div>
            ...
            <tbody>
              ...
              <tr className="bg-white bg-black/39  dark:bg-gray-800 text-[9px] md:text-[1rem]">
              ...
              </tr><tr className="bg-white bg-black/39  dark:bg-gray-800 text-[9px] md:text-[1rem]">
                <th scope="row" className="px-6 py-4 text-   font-medium text-gray-900 whitespace-nowrap dark:text-white">
                  Lorem Ipsum
                </th>
                <td className="px-2 md:px-6 py-4">
