  ...
  return (
    <section className="text-montserrat h-[90vh] w-screen absolute top-20 lg:top-10 flex flex-col lg:flex-row items-center gap-3 md:gap-12 lg:gap-10">
      ...
      <div className="containerbox h-[70vh] md:h-[60%] lg:h-[87%] xl:h-[72%] relative  overflow-y-auto lg:overflow-y-visible   w-[90%] lg:w-[75%] py-2  z-20 flex flex-col items-center">
        ...
        <h1 className="text-lg font-bold py-2 lg:absolute lg:top-[-32px] lg:left-[-20px] lg:uppercase lg:text-4xl xl:text-5xl lg:font-black">Cumpleaños</h1>

        <div className="flex items-center gap-6 xl:py-4">
          <img className=" scale-75 rotate-180 xl:scale-100" src="./img/arrow-right.svg" alt="previous-year-selector" />
          <h1 className="text-2xl font-semibold xl:text-4xl">2023</h1>
          <img className="scale-75 xl:scale-100" src="./img/arrow-right.svg" alt="previous-year-selector" />
        </div>


        <div className="lg:flex overflow-y-auto py-8">
          <div className="detailcontainr  flex flex-col items-center   ">
            <h1 className="text-2xl font-semibold whitespace-nowrap pb-4 xl:text-4xl xl:font-bold">2 de Noviembre</h1>

            <p className="py-4 overflow-y-auto lg:w-[350px] xl:w-[700px]   px-4 lg:mx-0  font-semibold text-sm lg:text-lg xl:text-2xl ">Vinieron todos sus amigos desde el vecindario
              a celebrar su cumpleaños.
              La pasaron excelente!
              La pasaron excelente!
          ...
          <div className="grid grid-cols-2 gap-6 px-7 overflow-y-auto lg:w-[90%] xl:w-[85%]">
